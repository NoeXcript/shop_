...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['faq_content'])) {
		$valid = 0;
		$error_message .= 'O conteúdo não pode ficar vazio<br>';
	}
	...
	if($valid == 1) {
		...
		$success_message = 'FAQ adicionadas com sucesso';
			...
			<form class="form-horizontal" action="" method="post">
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Conteúdo <span>*</span></label>
							<div class="col-sm-9">
