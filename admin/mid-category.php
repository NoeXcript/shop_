            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    ...
	                    <td>
	                        <a href="mid-category-edit.php?id=<?php echo $row['mcat_id']; ?>" class="btn btn-primary btn-xs">Atualizar</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Tome cuidado! Todos os produtos e categorias de nível final nesta categoria de nível médio serão excluídos de todas as tabelas, como tabela de pedidos, tabela de pagamentos, tabela de tamanhos, tabela de cores, tabela de classificação, etc.</p>
            </div>
