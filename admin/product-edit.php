...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
    	...
    	$success_message = 'O produto foi atualizado com sucesso.';
    }
}
?>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Preço atual<span>*</span><br><span style="font-size:10px;font-weight:normal;">(em AO)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Foto existente em destaque</label>
