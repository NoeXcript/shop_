...
if(isset($_POST['form1'])) {
	...
	$success_message = 'URLs de mídia social foram atualizados com sucesso.';
		...
		<div class="col-md-12">
			...
			<form class="form-horizontal" action="" method="post">
				<div class="box box-info">
					<div class="box-body">						
						<p style="padding-bottom: 20px;">Se você não quiser mostrar uma mídia social em sua página inicial, basta deixar o campo de entrada em branco.</p>
