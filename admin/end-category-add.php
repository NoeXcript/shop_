...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['ecat_name'])) {
        $valid = 0;
        $error_message .= "O nome da categoria de nível final não pode ficar vazio<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'A categoria de nível final foi adicionada com sucesso.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="end-category.php" class="btn btn-primary btn-sm">Ver Todas</a>
	</div>
</section>
