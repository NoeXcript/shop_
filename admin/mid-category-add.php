...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_name'])) {
        $valid = 0;
        $error_message .= "O nome da categoria de nível médio não pode ficar vazio<br>";
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'A categoria de nível médio foi adicionada com sucesso.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="mid-category.php" class="btn btn-primary btn-sm">Ver todas</a>
	</div>
</section>
