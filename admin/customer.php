					...
					<table id="example1" class="table table-bordered table-hover table-striped">
						<thead>
							<tr>
								...
								<th width="180">País, Cidade, Estado</th>
								<th>Status</th>
								<th width="100">Trocar  Status</th>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr class="<?php if($row['cust_status']==1) {echo 'bg-g';}else {echo 'bg-r';} ?>">
									...
									<td>
										<a href="customer-change-status.php?id=<?php echo $row['cust_id']; ?>" class="btn btn-success btn-xs">Trocar Status</a>
									</td>
									<td>
