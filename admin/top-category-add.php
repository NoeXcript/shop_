...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "O nome da categoria principal não pode ficar vazio<br>";
    } else {
    ...
    if($valid == 1) {
    	...
    	$success_message = 'A categoria principal foi adicionada com sucesso.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Adicionar categoria de nível superior</h1>
	</div>
	<div class="content-header-right">
		<a href="top-category.php" class="btn btn-primary btn-sm">Ver todas</a>
	</div>
</section>
