...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
        $valid = 0;
        $error_message .= 'Você deve selecionar uma província.<br>';
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'O custo de envio foi adicionado com sucesso.';
    }
                ...
                <div class="box box-info">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Selecione a província <span>*</span></label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Quantia <span>*</span></label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <button type="submit" class="btn btn-success pull-left" name="form1">Adicione</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    ...
	                    <td>
	                        <a href="shipping-cost-edit.php?id=<?php echo $row['shipping_cost_id']; ?>" class="btn btn-primary btn-xs">Atualizar</a>
      ...
      <h4 style="background: #dd4b39;color:#fff;padding:10px 20px;">NB: Se uma província não existir na lista acima, serão aplicados os seguintes custos de envio "Resto do país"..</h4>
...
<section class="content-header">
    <div class="content-header-left">
        <h1>Custo de envio (resto do país)</h1>
    </div>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Tens certeza que queres eliminar este item?
