...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="slider-add.php" class="btn btn-primary btn-sm">Adicionar Slider</a>
	</div>
</section>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td>										
										<a href="slider-edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-xs">Atualizar</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Tens certeza que queres eliminar este item?</p>
            </div>
