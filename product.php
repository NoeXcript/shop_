...
if(isset($_POST['form_add_to_cart'])) {
    ...
    if(isset($_SESSION['cart_p_id']))
    {
        ...
        if($added == 1) {
           $error_message1 = 'Este produto já foi adicionado ao carrinho de compras.';
        } else {
                                    ...
                                    <div class="review-form">
                                        ...
                                        <?php if(isset($_SESSION['customer'])): ?>
                                            ...
                                            <div class="form-group">
                                                <textarea name="comment" class="form-control" cols="30" rows="10" placeholder="Escreva seu comentário (opcional)" style="height:100px;"></textarea>
                                            </div>
