...
if ( (!isset($_REQUEST['email'])) || (isset($_REQUEST['token'])) )
{
    ...
    if($var != 0)
    {
        ...
        $success_message = '<p style="color:green;">Seu e-mail foi verificado com sucesso. Agora você pode fazer login em nosso site.</p><p><a href="'.BASE_URL.'login.php" style="color:#167ac6;font-weight:bold;">Click here to login</a></p>';     
    }
}
?>
